        ...
        children: [
          if (mangaSettingsController.picaPageViewMode.value)
            Row(
              ...
              children: [
                TextButton(
                    onPressed: downloadStore.tasks.length <= dc.perPage
                        ? null
                        : () {
                            showMoonModal(
                                context: context,
                    ...
                    child: Text('at_page'.trParams({
                      ...
                      'total':
                          (downloadStore.tasks.length / dc.perPage).ceil() == 0
                              ? "1"
          ...
          Expanded(
            child: ListView.builder(
                itemBuilder: (context, index) {
                  return DownloadComicCard(
                      downloadStore.tasks[index]);
                },
                itemCount: downloadStore.tasks.length,
                controller: scrollController),
          ),
        ],
      ),
