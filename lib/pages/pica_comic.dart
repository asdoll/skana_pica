                ...
                child: TabBarView(
                  ...
                  children: [
                        ...
                        Wrap(
                          ...
                          children: [
                            if (comicDetailController.currentEps.value != 0 ||
                              ...
                              picaChoiceChip(
                                backgroundColor: Get
                                    .context!.moonTheme?.tokens.colors.chichi60,
                                selectedColor: Get
                                    .context!.moonTheme?.tokens.colors.chichi,
                                disabledColor: Get
                                    .context!.moonTheme?.tokens.colors.chichi60,
                                text: "continue_page".trParams({
                                  "eps": comicDetailController.comic.value.eps[
                                      comicDetailController.currentEps.value],
                                  "page": (comicDetailController
                                              .currentIndex.value +
                                          1)
                                      .toString()
                                }),
                            ...
                            for (int index = 0;
                                index <
                                    comicDetailController
                                        .comic.value.eps.length;
                                index++)
                              picaChoiceChip(
                                text: comicDetailController
                                    .comic.value.eps[index],
                                selected: false,
                                onSelected: (bool value) {
                    ...
                    ListView(
                      children: [
                        SizedBox(height: 16),
                        PicaCommentBar(comicDetailController.comic.value.id, isComic: true),
                        for (int index = 0;
                            index <
                                min(
                                    comicDetailController
