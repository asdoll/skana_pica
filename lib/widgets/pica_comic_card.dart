  ...
  Widget build(BuildContext context) {
    return Obx(() => Padding(
        ...
        child: moonListTileWidgets(
            menuItemPadding: EdgeInsets.all(2),
            onTap: () {
            ...
            leading: PicaImage(
              ...
              height: 150,
              fit: BoxFit.cover,
            ).rounded(8.0).paddingAll(6),
            trailing: PicaFavorButton(comic.id).paddingOnly(top: 2),
            label: Column(
              ...
              children: [
                Padding(
                  ...
                  child: Text(
                    ...
                    maxLines: visitHistoryController.history[comic.id] != null
                        ? 2
                        : 3,
                  ).header(),
                ),
                  ...
                  Row(
                    children: [
                      PicaTag(
                        ...
                        type: "placed",
                        backgroundColor:
                            Get.context!.moonTheme?.tokens.colors.nappa60,
                      ),
                    ],
                  ),
                const SizedBox(
